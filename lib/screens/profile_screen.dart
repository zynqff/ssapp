...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Future<void> _confirmLogout() async {
    ...
    if (confirmed == true && mounted) {
      // Просто выходим — _Root в main.dart автоматически покажет LoginScreen
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          style: GoogleFonts.playfairDisplay(
                            color: cs.primary, fontSize: 22, fontWeight: FontWeight.w600,
                          ),
                        ),
                      ),
                    ),
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: label,
        labelStyle:
            GoogleFonts.notoSerif(color: cs.onSurfaceVariant, fontSize: 13),
